      ...
      <div className="banner bg-gradient-to-br from-[#F4CFD7] to-[#FFFFFF]">
        <nav className="dark:bg-gray-900 w-full border-b border-gray-300 dark:border-gray-600">
          <div className="max-w-screen-xl flex items-center gap-x-4 mx-auto p-4">
            <Link
              href="/"
              className="flex items-center space-x-3 rtl:space-x-reverse w-[160px] md:w-[200px]"
            >
              <img
            ...
            <div className="flex justify-end md:justify-between w-[calc(100%-160px)] md:w-[calc(100%-200px)]">
              ...
              <div className="flex space-x-2 md:space-x-4">
                <span className="flex items-center">
                  <svg
                    className="w-5 h-5 md:w-6 md:h-6 text-gray-600 dark:text-white"
                    aria-hidden="true"
          ...
          >
                ...
                <div className="md:flex items-center">
                  <div className="w-full md:w-7/12 flex justify-center">
                    <div className="py-4 w-3/5">
                      ...
                      <p className="my-6">
                        A team of 100+ experienced developers and designers,
                        ready to help you build your web and mobile
                        applications.
                      </p>
                      <div className="">
            ...
            >
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg
                  className="w-4 h-4 text-gray-400 dark:text-gray-800 rtl:rotate-180"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 6 10"
