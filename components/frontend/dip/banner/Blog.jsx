        ...
        <div className="banner bg-gradient-to-br from-[#F4CFD7] to-[#FFFFFF]">
            ...
            <div className="mx-auto w-full max-w-screen-xl px-4 py-12">
                <div className="flex flex-col justify-center items-center">
                    <h2 className="text-2xl text-gray-900 font-blog">STANDARD BLOG’S</h2>
                    <nav className="flex mt-3" aria-label="Breadcrumb">
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                ...
                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Blog</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
