        ...
        <div className="banner bg-gradient-to-br from-[#F4CFD7] to-[#FFFFFF]">
            <nav className="dark:bg-gray-900 w-full border-b border-gray-300 dark:border-gray-600">
                <div className="max-w-screen-xl flex items-center gap-x-4 mx-auto p-4">
                    <Link href="/dip" className="flex items-center space-x-3 rtl:space-x-reverse w-[160px] md:w-[200px]">
                    ...
                    <nav className="flex mt-3" aria-label="Breadcrumb">
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                ...
                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Portfolio</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
