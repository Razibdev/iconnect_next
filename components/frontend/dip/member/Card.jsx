  ...
  return (
    <div>
        <div className="card relative overflow-hidden bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ease-in-out duration-300 hover:shadow-lg hover:-translate-y-4">
            ...
            <div className="absolute w-2 h-12 bottom-0 left-0 bg-[#1F2D77] rounded-tr-lg"></div>
            <div className="absolute w-2 h-12 bottom-0 right-0 bg-[#1F2D77] rounded-tl-lg"></div>
            <div className="absolute w-full h-2 bottom-0 left-0 bg-[#1F2D77]"></div>
        </div>
    </div>
  )
}
